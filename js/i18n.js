...
DICT.cs = {
  ...
  "resume.title": "Rozehraná hra",
  "resume.go": "Pokračovat",
  "resume.discard": "Zahodit",
  "resume.solo": "{map} · {clock} na hodinách · zbývá {n} {n:možnost|možnosti|možností}",
  "resume.match": "{map} · {round}. kolo · hledá {seeker}, schovává se {hider} · {clock} na hodinách",
  "resume.hiding": "{map} · {round}. kolo · {hider} si vybírá úkryt",
  "resume.found": "{map} · dohráno, skrývač nalezen · {clock} na hodinách",
  "resume.saved": "uloženo v {time}",
  ...
  // A player name is whatever they typed, so it cannot be declined: every
  // Czech sentence below is built to leave the name in the nominative.
  "ui.modeMatch": "{round}. kolo · hledá {seeker}, schovává se {hider} · náskok {window}",
  ...
  "res.matchTitle": "{hider} nalezen na zastávce {name} — hledal {seeker}",
  ...
  "res.next": "Další na řadě: {name} — {n}. kolo",
...
DICT.en = {
  ...
  "resume.title": "A round in progress",
  "resume.go": "Continue",
  "resume.discard": "Discard",
  "resume.solo": "{map} · {clock} on the clock · {n} station{n:|s} still possible",
  "resume.match": "{map} · round {round} · {seeker} seeking {hider} · {clock} on the clock",
  "resume.hiding": "{map} · round {round} · {hider} is choosing where to hide",
  "resume.found": "{map} · finished, the hider was found · {clock} on the clock",
  "resume.saved": "saved at {time}",
